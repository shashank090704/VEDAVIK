...
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100 py-12 px-4 sm:px-6 lg:px-8 text-black">
//       <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
//         <div className="bg-green-600 px-6 py-4">
//           <h2 className="text-2xl font-bold text-white text-center">Create Crop Order</h2>
//         </div>

//         <div className="p-6">
//           <p className="text-gray-600 mb-6 text-center">
//             Submit your crop requirements to connect with farmers
//           </p>
...
//             <div>
//               <label htmlFor="amountPerKg" className="block text-sm font-medium text-gray-700">
//                 Amount per Kg (₹)
//               </label>
