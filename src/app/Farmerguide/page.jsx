...
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-green-50 to-emerald-100 py-8 px-4 sm:px-6 lg:px-8 text-black">
...
//             </div>
//           </div>
//           <h1 className="text-4xl font-bold text-green-800 mb-2">Sarthi</h1>
//           <p className="text-lg text-gray-600">Your Agricultural Assistant</p>
//         </div>

//         <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
//           <div className="bg-gradient-to-r from-green-600 to-green-500 px-6 py-4">
//             <h2 className="text-xl font-bold text-white">Ask Anything About Farming</h2>
//             <p className="text-green-100 text-sm mt-1">Get expert advice on crops, techniques, market prices, and more</p>
//           </div>

//           <form onSubmit={generateAnswer} className="p-6">
//             <div className="mb-4">
//               <textarea
//                 required
//                 className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300 min-h-32 text-gray-700"
//                 value={question}
//                 onChange={(e) => setQuestion(e.target.value)}
//                 placeholder="Examples: What are the best crops for sandy soil? How do I control pests organically? What's the current market price for wheat?"
//               ></textarea>
//             </div>
...
//                 type="submit"
//                 disabled={generatingAnswer}
//                 className={`px-6 py-3 bg-green-600 text-white font-medium rounded-lg shadow hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-300 flex items-center ${
...
//         {answer && (
//           <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8 transition-all duration-500 animate-fade-in">
//             <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-4">
//               <h2 className="text-xl font-bold text-white">Sarthi's Answer</h2>
//               <p className="text-blue-100 text-sm mt-1">Expert agricultural guidance</p>
//             </div>
...
//           <h3 className="text-lg font-medium text-green-800 mb-2">Popular Questions</h3>
//           <div className="space-y-2">
//             {[
//               "What are the best practices for water conservation?",
//               "How do I prepare my soil for the monsoon season?",
//               "What government schemes are available for farmers?",
//               "How can I get the best price for my crops?"
//             ].map((q, i) => (
//               <button
//                 key={i}
//                 onClick={() => setQuestion(q)}
//                 className="block w-full text-left p-3 bg-green-50 hover:bg-green-100 rounded-lg text-green-800 transition-colors duration-200"
//               >
//                 {q}
//               </button>
//             ))}
...
//           <p>Sarthi - Empowering farmers with AI-powered agricultural guidance</p>
//         </div>
//       </div>
//     </div>
//   );
...
//           </div>
//           <p className="text-sm hidden md:block">Your Farming Assistant</p>
//         </div>
//       </header>
